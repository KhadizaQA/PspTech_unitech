...
//	}
	...
	public void TC_004_header_AboutUS_button_click() {
		...
		CommonMethods.click(homepage.HomepageAboutusClick, driver);
//		CommonMethods.getTitle(driver, "AboutUs-PSPTech");
...
//	Actions act = new Actions(driver);
//	act.moveToElement(homepage.MouseOverCareer).build().perform();
//	CommonMethods.click(homepage.MouseOverCareer, driver);
//CommonMethods.getTitle(driver, "PSPTech – PSP Technology | Websites | Apps | Digital Solutions - PSPTech");
//	CommonMethods.click(homepage.ClickHome, driver);
//	}	
...
//	Actions act = new Actions(driver);
//	act.moveToElement(homepage.MouseOverContactUS).build().perform();
//	CommonMethods.click(homepage.MouseOverContactUS, driver);
//CommonMethods.getTitle(driver, "PSPTech – PSP Technology | Websites | Apps | Digital Solutions - PSPTech");
//	CommonMethods.click(homepage.ClickHome, driver);
//}
